			...
			forTree = function(o) {
				...
				for ( var i = 0; i < o.length; i++) {
					...
					for ( var p in columns) {
						urlstr = urlstr + "<div><span>" + "<a>" + columns[p].columnname
								+ "</a></span></div>";
					}
		...
		$.ajax({
			...
			success : function(json) {
				...
				for ( var s in mcolumns) {
					tabletitle=tabletitle+"<th style=\"width:212px;text-align: center;background-color:#39AEF5;border-bottom:1px solid #444444;\">"+mcolumns[s]+"</th>";
